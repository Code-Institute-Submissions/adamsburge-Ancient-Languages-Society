...
Welcome to the Ancient Language Society. The Ancient Languages Society website is a site to help interested people discover the Society and get involved. The Society seeks to preserve the knowledge of ancient languages by teaching these languages for free to any person interested as well as by providing weekly reading groups for those who already know the languages.
...
The website is a single-page site with a menu that takes the user to different sections of the page. There are seven total sections: The Navigation, Home (or landing section), About Us, Teaching, Teachers, Events, and a Signup Form + Footer. Each section is designed to take up the entire view height of the screen on desktops. This feature is removed on mobile formats.
...
- The information is split into a table with each cell containing information relevant to one specific language
<br><br>
...
- The information is split into a tablet with each cell containing information relevant to one specific weekly meetup.
<br><br>
...
- The form requests the first and last name, email address, reason for signup and language interest from the user. The form is designed require entries in every field and to only accept a real email address format in the email address field. 
